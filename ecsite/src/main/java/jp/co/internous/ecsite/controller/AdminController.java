...
import jp.co.internous.ecsite.model.dmain.MstGoods;
import jp.co.internous.ecsite.model.dmain.MstUser;
...
public class AdminController {
	...
	public String deletApi(@RequestBody GoodsForm f, Model m) {
		try {
